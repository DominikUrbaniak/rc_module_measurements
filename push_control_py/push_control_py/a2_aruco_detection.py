...
#        )
        ...
        self.get_logger().info(f'Starting measurement with qos_profile: {self.qos_profile}, logging: {self.logging}, measurement duration: {self.communication_duration}')
        ...
        self.pose_publisher_ = self.create_publisher(PoseCommunication, 'aruco_detection/tag_poses', qos_profile=qos_profiles[self.qos_profile])
