...
from push_control_py.qos_profiles import qos_profile_R1, qos_profile_R5, qos_profile_R10, qos_profile_R20

qos_profiles = {'R1':qos_profile_R1, 'R5':qos_profile_R5, 'R10':qos_profile_R10, 'R20':qos_profile_R20}
...
class ImageService(Node):
    ...
    def __init__(self):
        ...
        self.service = self.create_service(PoseDetection, 'aruco_image_service', self.service_callback, qos_profile=qos_profiles[self.qos_profile])
